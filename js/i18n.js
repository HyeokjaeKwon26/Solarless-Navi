...
window.I18n = (function () {
    ...
    const translations = {
        'ko-KR': {
            ...
            searchSub: "NREL 태양 위치·Bird 기준·기상예보와 장면 차광으로 실험용 노출 지표를 계산합니다.",
            originLabel: "출발지",
            destLabel: "목적지 (필수)",
            ...
            lblAppWeb: "개발자 홈페이지",
            lblAppCert: "보안 서명",
            aboutDisclaimer: "NREL SPA·Bird 맑은하늘 기준, Open-Meteo 기상예보와 공개 장면 데이터로 계산한 실험용 추정값입니다. 실제 UV 선량·실내온도·의학적 보호효과가 아닙니다. 위치·경로 표본·검색어가 OSRM, Open-Meteo 등 외부 공개 API로 전송될 수 있으며, 오프라인에서는 실제 도로 경로를 계산하지 않습니다. 예보 실패 시 맑은하늘 또는 휴리스틱 등급을 명시합니다.",
            btnCloseAbout: "닫기",
        ...
        'en-US': {
            ...
            searchSub: "Uses NREL solar position, the Bird baseline, weather forecasts, and scene occlusion for experimental exposure estimates.",
            originLabel: "Origin",
            ...
            aboutDisclaimer: "Experimental estimates from NREL SPA, the Bird clear-sky baseline, Open-Meteo forecasts, and public scene data—not measured UV dose, cabin temperature, or medical protection. Location, route samples, and search terms may be sent to public APIs including OSRM and Open-Meteo. Real road routing is unavailable offline. Forecast failures are labeled as clear-sky or heuristic fallbacks.",
            btnCloseAbout: "Close",
            ...
            trafficCardTitle: "OSRM Profile ETA Estimates",
            ...
            shadeDesc: "Confirmed shade first; estimated where data is missing",
