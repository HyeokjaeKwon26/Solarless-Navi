...
window.I18n = (function () {
    ...
    const translations = {
        'ko-KR': {
            ...
            searchSub: "NREL 태양 위치·Bird 맑은하늘 일사와 장면 차광으로 실험용 노출 지표를 계산합니다.",
            originLabel: "출발지",
            destLabel: "목적지 (필수)",
            ...
            lblAppWeb: "개발자 홈페이지",
            lblAppCert: "보안 서명",
            aboutDisclaimer: "NREL SPA·Bird 맑은하늘 일사와 공개 장면 데이터로 계산한 실험용 추정값입니다. 실제 UV 선량·실내온도·의학적 보호효과가 아닙니다. 위치와 검색어가 외부 공개 API로 전송될 수 있으며, 오프라인에서는 실제 도로 경로를 계산하지 않습니다. 휴리스틱·부분 장면·정밀 장면 계층을 구분해 표시합니다.",
            btnCloseAbout: "닫기",
        ...
        'en-US': {
            ...
            searchSub: "Uses NREL solar position, Bird clear-sky irradiance, and scene occlusion for experimental exposure estimates.",
            originLabel: "Origin",
            ...
            aboutDisclaimer: "Experimental estimates from NREL SPA, Bird clear-sky irradiance, and public scene data—not measured UV dose, cabin temperature, or medical protection. Location and search terms may be sent to public APIs, and real road routing is unavailable offline. Heuristic, partial-scene, and precision-scene tiers are labeled separately.",
            btnCloseAbout: "Close",
