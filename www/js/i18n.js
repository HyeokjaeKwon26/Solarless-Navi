...
window.I18n = (function () {
    ...
    const translations = {
        'ko-KR': {
            ...
            lblAppWeb: "개발자 홈페이지",
            lblAppCert: "보안 서명",
            aboutDisclaimer: "실험용 추정값입니다. 경로·장소·도로 규칙 조회를 위해 위치와 검색어가 외부 공개 API로 전송될 수 있으며, 오프라인에서는 실제 도로 경로를 계산하지 않습니다. 시간 변경 시 OSRM 경로 형상은 재사용하고 태양 분석만 갱신합니다. 휴리스틱·부분 장면·정밀 장면 계층을 구분해 표시합니다.",
            btnCloseAbout: "닫기",
        ...
        'en-US': {
            ...
            aboutDisclaimer: "Experimental estimates only. Your location and search terms may be sent to public APIs for routing, place search, and road-rule lookup; real road routing is unavailable offline. Time changes reuse OSRM geometry and refresh solar analysis. Heuristic, partial-scene, and precision-scene tiers are labeled separately.",
            btnCloseAbout: "Close",
